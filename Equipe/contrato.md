...
- Canal principal: Grupo do Whatsapp
- Prazo esperado de resposta: Algumas horas
- Canal para urgência: Numero de celular
## 3. Quando nos reunimos
- Dia e horário fixo, fora do horário de aula: Aos fins de semana de forma online
- Duração prevista: 1-2 horas
...
| | |
## 5. Como decidimos
Quando houver discordância, decidimos por:
(X) consenso ( ) maioria ( ) responsável pela área decide
## 6. Nossos combinados
...
## 8. Assinaturas
Todos os integrantes leram e concordam. O commit deste arquivo,
com os nomes acima, vale como concordância.
